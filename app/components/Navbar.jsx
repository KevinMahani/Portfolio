...
//   className={`mt-5 pt-2 flex  items-center gap-2 rounded cursor-pointer hover:text-white transition-colors ${
//     showFrontEnd ? "text-white" : "text-white/50"
//   }`}
// >
//   <span>Front-End Projects</span>
//   {showFrontEnd && <motion.span
//     // animate={{ rotate: showFrontEnd ? -90 : 0 }}
//     transition={{ duration: 0.2 }}
//   >
//     <MdOutlineKeyboardDoubleArrowDown  className="text-m  " />
//   </motion.span>}
// </button>
